...
import CompareRevisions.API.Internal (HTML)
  ...
  mimeRender _ _ =
    toS
      [NI.text|
         <!doctype html>
         <html>
         <head><title>compare-revisions</title></head>
         <body>
         ...
         <p>
         Source code at <a href="https://github.com/jml/compare-revisions">https://github.com/jml/compare-revisions/</a>
         </p>
         </body>
         <html>
         |]
